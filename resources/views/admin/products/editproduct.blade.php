                ...
                <div class="modal-body bg-light">
                    <div class="card-body">
                                ...
                                <select name="category" class="form-select" id="category">
                                    @isset($categories)
                                        @foreach($categories as $category)
                                            <option value="{{$category->id}}" {{$category->id == $product->category->id ? 'selected':null}}>{{$category->name}}</option>
                                        @endforeach
                                    @endisset
                                </select>
                            </div>
                                ...
                                <select name="subcategory" class="form-select" id="subcategory">
                                    @isset($subcategories)
                                        @foreach($subcategories as $subcategory)
                                            <option value="{{$subcategory->id}}" {{$subcategory->id == $product->subcategory->id ? 'selected':null}}>{{$subcategory->name}}</option>
                                        @endforeach
                                    @endisset
                                </select>
                            </div>
                                ...
                                <select name="brand" class="form-select" id="brand">
                                    @isset($brands)
                                        @foreach($brands as $brand)
                                            <option value="{{$brand->id}}" {{$brand->id == $product->brand->id ? 'selected':null}}>{{$brand->name}}</option>
                                        @endforeach
                                    @endisset
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="model" value="{{$product->model}}" class="form-control" id="model"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="regularprice" value="{{$product->regular_price}}" class="form-control" id="regularprice"
                                       placeholder="13800">
                            </div>
                            @error('regularprice')
                            <span class="text-center">{{$message}}</span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="summary" class="form-control" id="ckeditor1">{!!$product->summary!!}</textarea>
                            </div>
                            @error('summary')
                            <span class="text-center">{{$message}}</span>
                            @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="specification" class="form-control" id="ckeditor2">{!!$product->specification!!}</textarea>
                            </div>
                            @error('specification')
                            <span class="text-center">{{$message}}</span>
                            @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" class="form-control" id="ckeditor3">{!!$product->description!!}</textarea>
                            </div>
                            @error('description')
                            <span class="text-center">{{$message}}</span>
                            @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset('storage/products/'.$product->product_img)}}" width="50px" height="50px" alt="">
